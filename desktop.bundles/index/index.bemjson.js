				...
				},
				{
					...
					content: [
						[
							...
							{time: '12:45', destination: 'Jerez', flight: 'KHH 1234', counter: '23/12', boarding: '12:21', gate: 21, remarks: 'delayed', description: 'По самому бюджетному тарифу Light можно будет улететь в одну сторону за 89 евро без багажа (за провоз клади придется доплатить 10 евро). По классическому тарифу перелет обойдется минимум в 129 евро, а если пассажир решит доплатить за возможность взять багаж и получить возможность двигать даты поездки, это ему будет стоить около 300 евро в одну сторону. Ценообразование бизнес-класса не изменится, говорится в сообщении компании.'},
							...
							{time: '13:40', destination: 'Moscu/VKO', flight: 'KHH 1234', counter: '23/12', boarding: '12:21', gate: 21, remarks: 'delayed', description: 'По самому бюджетному тарифу Light можно будет улететь в одну сторону за 89 евро без багажа (за провоз клади придется доплатить 10 евро). По классическому тарифу перелет обойдется минимум в 129 евро, а если пассажир решит доплатить за возможность взять багаж и получить возможность двигать даты поездки, это ему будет стоить около 300 евро в одну сторону. Ценообразование бизнес-класса не изменится, говорится в сообщении компании.'},
							{time: '15:00', destination: 'Dublin', flight: 'KHH 1234', counter: '23/12', boarding: '12:21', gate: 21, remarks: 'delayed', description: 'По самому бюджетному тарифу Light можно будет улететь в одну сторону за 89 евро без багажа (за провоз клади придется доплатить 10 евро). По классическому тарифу перелет обойдется минимум в 129 евро, а если пассажир решит доплатить за возможность взять багаж и получить возможность двигать даты поездки, это ему будет стоить около 300 евро в одну сторону. Ценообразование бизнес-класса не изменится, говорится в сообщении компании.'}
						].map(function(item, i) {
							return {
									elem: 'row',
									num: i,
